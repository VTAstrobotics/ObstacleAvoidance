...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/hal/workspace/src/rviz)
  set(rviz_DEVEL_PREFIX /home/hal/workspace/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/hal/workspace/install)
...
if(NOT "/home/hal/workspace/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/hal/workspace/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hal/workspace/src/rviz/${idir}'.  ${_report}")
    endif()
